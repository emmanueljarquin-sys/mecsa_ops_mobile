            ...
            if (provider.puedeVerChat) ...[
              ...
              ListTile(
                ...
                leading: Icon(Icons.chat_bubble_outline,
                    color: ChatConfig.conectado ? const Color(0xFF25D366) : Colors.orange),
                title: const Text("Chat CRM (WhatsApp)"),
                subtitle: Text(ChatConfig.conectado
                    ? 'Conectado a waba_crm · admin ve todo, los demás sus asignados'
                    : 'Pendiente de conectar con waba_crm (falta habilitar acceso en Supabase)'),
              ),
            ],
